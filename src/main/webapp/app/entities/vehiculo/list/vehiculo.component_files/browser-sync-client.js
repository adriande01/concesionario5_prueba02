...
___browserSync___.socketUrl = 'http://' + location.hostname + ':9001/browser-sync';
___browserSync___.options = {
  ...
  reloadDebounce: 500,
  mode: 'proxy',
  scriptPaths: { path: '/browser-sync/browser-sync-client.js', versioned: '/browser-sync/browser-sync-client.js?v=2.27.10' },
  server: false,
  logFileChanges: true,
  reloadThrottle: 0,
  clientEvents: ['scroll', 'scroll:element', 'input:text', 'input:toggles', 'form:submit', 'form:reset', 'click'],
  urls: { local: 'http://localhost:9000', external: 'http://192.168.1.64:9000' },
  ...
  tagNames: { jpg: 'img', css: 'link', svg: 'img', gif: 'img', jpeg: 'img', js: 'script', png: 'img', scss: 'link', less: 'link' },
  scrollRestoreTechnique: 'window.name',
  watch: false,
  watchOptions: { ignoreInitial: true, cwd: 'C:\\Users\\CAS\\Desktop\\concesionario5' },
  cwd: 'C:\\Users\\CAS\\Desktop\\concesionario5',
  logConnections: false,
  ghostMode: { clicks: true, scroll: true, location: true, forms: { submit: true, inputs: true, toggles: true } },
  middleware: [{ id: 'Browsersync Proxy', route: '' }],
  ignore: [],
  injectChanges: true,
  excludedFileTypes: [
    'js',
...
(() => {
  ...
  var f = (r, t) => () => (t || r((t = { exports: {} }).exports, t), t.exports),
    ...
    Ol = (r, t, e, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let i of gl(t)) !wl.call(r, i) && i !== e && Tr(r, i, { get: () => t[i], enumerable: !(n = bl(t, i)) || n.enumerable });
      return r;
    };
  var c = (r, t, e) => (
    (e = r != null ? yl(_l(r)) : {}), Ol(t || !r || !r.__esModule ? Tr(e, 'default', { value: r, enumerable: !0 }) : e, r)
  );
  var di = f((gy, ue) => {
    var Gn, Xn, Jn, Zn, Qn, ti, ei, ri, ni, ae, Ar, ii, oi, si, ht, ai, ci, ui, fi, li, pi, hi, mi, ce;
    (function (r) {
      ...
      (Gn = function (n, i) {
        ...
        (Jn = function (n, i) {
          var o = {};
          for (var s in n) Object.prototype.hasOwnProperty.call(n, s) && i.indexOf(s) < 0 && (o[s] = n[s]);
          if (n != null && typeof Object.getOwnPropertySymbols == 'function')
            for (var a = 0, s = Object.getOwnPropertySymbols(n); a < s.length; a++)
              i.indexOf(s[a]) < 0 && Object.prototype.propertyIsEnumerable.call(n, s[a]) && (o[s[a]] = n[s[a]]);
          return o;
        }),
        (Zn = function (n, i, o, s) {
          var a = arguments.length,
            u = a < 3 ? i : s === null ? (s = Object.getOwnPropertyDescriptor(i, o)) : s,
            l;
          if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function') u = Reflect.decorate(n, i, o, s);
          else for (var h = n.length - 1; h >= 0; h--) (l = n[h]) && (u = (a < 3 ? l(u) : a > 3 ? l(i, o, u) : l(i, o)) || u);
            ...
            for (; o; )
              try {
                if (
                  ((s = 1),
                  a &&
                    (u = m[0] & 2 ? a.return : m[0] ? a.throw || ((u = a.return) && u.call(a), 0) : a.next) &&
                    !(u = u.call(a, m[1])).done)
                )
                  return u;
                switch (((a = 0), u && (m = [m[0] & 2, u.value]), m[0])) {
                  ...
                  case 7:
                    ...
                    continue;
                  default:
                    if (((u = o.trys), !(u = u.length > 0 && u[u.length - 1]) && (m[0] === 6 || m[0] === 2))) {
                      o = 0;
                      continue;
                    }
        ...
        (ni = function (n, i) {
          for (var o in n) o !== 'default' && !Object.prototype.hasOwnProperty.call(i, o) && ce(i, n, o);
        }),
        (ce = Object.create
          ? function (n, i, o, s) {
              s === void 0 && (s = o),
        ...
        (Ar = function (n, i) {
          ...
          var s = o.call(n),
            ...
            l;
          try {
            for (; (i === void 0 || i-- > 0) && !(a = s.next()).done; ) u.push(a.value);
          } catch (h) {
            l = { error: h };
          } finally {
            try {
        ...
        (ii = function () {
          for (var n = [], i = 0; i < arguments.length; i++) n = n.concat(Ar(arguments[i]));
          return n;
        }),
        (oi = function () {
          for (var n = 0, i = 0, o = arguments.length; i < o; i++) n += arguments[i].length;
          for (var s = Array(n), a = 0, i = 0; i < o; i++) for (var u = arguments[i], l = 0, h = u.length; l < h; l++, a++) s[a] = u[l];
          return s;
        }),
        (si = function (n, i, o) {
        ...
        (ai = function (n, i, o) {
          ...
          function _(p) {
            p.value instanceof ht ? Promise.resolve(p.value.v).then(m, C) : R(u[0][2], p);
          }
          function m(p) {
            h('next', p);
          }
        ...
        (ci = function (n) {
          ...
          function s(a, u) {
            i[a] = n[a]
              ? function (l) {
                  return (o = !o) ? { value: ht(n[a](l)), done: a === 'return' } : u ? u(l) : l;
                }
              : u;
          }
        }),
        ...
        (fi = function (n, i) {
          return Object.defineProperty ? Object.defineProperty(n, 'raw', { value: i }) : (n.raw = i), n;
        });
      var e = Object.create
        ? function (n, i) {
      ...
      (li = function (n) {
        ...
        var i = {};
        if (n != null) for (var o in n) o !== 'default' && Object.prototype.hasOwnProperty.call(n, o) && ce(i, n, o);
        return e(i, n), i;
      }),
        (pi = function (n) {
  ...
  var z = f(bi => {
    ...
    var xl = typeof window < 'u' && window,
      El = typeof self < 'u' && typeof WorkerGlobalScope < 'u' && self instanceof WorkerGlobalScope && self,
      kl = typeof global < 'u' && global,
      yi = xl || kl || El;
    bi.root = yi;
    (function () {
      if (!yi) throw new Error('RxJS could not find any global context (window, self, global)');
    })();
  });
  var fe = f(gi => {
    'use strict';
        ...
        return (
          (r.prototype.unsubscribe = function () {
            ...
            if (!this.closed) {
              ...
              for (var u = -1, l = o ? o.length : 0; i; ) i.remove(this), (i = (++u < l && o[u]) || null);
              if (Bl.isFunction(s)) {
                var h = Ti.tryCatch(s).call(this);
                h === mt.errorObject &&
                  ((t = !0),
                  (e = e || (mt.errorObject.e instanceof he.UnsubscriptionError ? Ai(mt.errorObject.e.errors) : [mt.errorObject.e])));
              }
              if (Pl.isArray(a))
                for (u = -1, l = a.length; ++u < l; ) {
                  ...
                  if (ql.isObject(_)) {
                    ...
                    if (h === mt.errorObject) {
                      ...
                      m instanceof he.UnsubscriptionError ? (e = e.concat(Ai(m.errors))) : e.push(m);
                    }
                  }
                }
          ...
          (r.prototype._addParent = function (t) {
            var e = this,
              n = e._parent,
              i = e._parents;
            !n || n === t ? (this._parent = t) : i ? i.indexOf(t) === -1 && i.push(t) : (this._parents = [t]);
          }),
          (r.EMPTY = (function (t) {
            return (t.closed = !0), t;
          })(new r())),
  ...
  var de = f(me => {
    ...
    var Ll = z(),
      Nr = Ll.root.Symbol;
    me.rxSubscriber = typeof Nr == 'function' && typeof Nr.for == 'function' ? Nr.for('rxSubscriber') : '@@rxSubscriber';
  ...
  var P = f(ve => {
          ...
          switch (
            ...
            case 1:
              ...
              if (typeof e == 'object') {
                ...
                } else (this.syncErrorThrowable = !0), (this.destination = new Ii(this, e));
                break;
              }
            default:
              (this.syncErrorThrowable = !0), (this.destination = new Ii(this, e, n, i));
              break;
          }
        }
        return (
      ...
      return (
        (t.prototype.next = function (e) {
          if (!this.isStopped && this._next) {
            ...
            n.syncErrorThrowable ? this.__tryOrSetError(n, this._next, e) && this.unsubscribe() : this.__tryOrUnsub(this._next, e);
          }
        }),
        (t.prototype.error = function (e) {
          if (!this.isStopped) {
            ...
            else if (n.syncErrorThrowable) (n.syncErrorValue = e), (n.syncErrorThrown = !0), this.unsubscribe();
        ...
        (t.prototype.complete = function () {
          ...
          if (!this.isStopped) {
            ...
            if (this._complete) {
              ...
              n.syncErrorThrowable ? (this.__tryOrSetError(n, i), this.unsubscribe()) : (this.__tryOrUnsub(i), this.unsubscribe());
    ...
    function Fl(r) {
      return r instanceof qr || ('syncErrorThrowable' in r && r[Pr.rxSubscriber]);
    }
  });
  var ji = f(Bi => {
    'use strict';
    ...
    function $l(r, t, e) {
      ...
      return !r && !t && !e ? new Br.Subscriber(Dl.empty) : new Br.Subscriber(r, t, e);
    }
    Bi.toSubscriber = $l;
  });
  var ye = f(Rt => {
    ...
    function Li(r) {
      var t,
        e = r.Symbol;
      return (
        typeof e == 'function' ? (e.observable ? (t = e.observable) : ((t = e('observable')), (e.observable = t))) : (t = '@@observable'), t
      );
    }
      ...
      Gl = (function () {
        ...
        return (
          ...
          (r.prototype.subscribe = function (t, e, n) {
            ...
            if (
              (i ? i.call(o, this.source) : o.add(this.source || !o.syncErrorThrowable ? this._subscribe(o) : this._trySubscribe(o)),
              o.syncErrorThrowable && ((o.syncErrorThrowable = !1), o.syncErrorThrown))
            )
  ...
  var ge = f(be => {
    ...
    var Xl =
      ...
      Zl = (function (r) {
        Xl(t, r);
        function t(e, n) {
          r.call(this), (this.value = e), (this.scheduler = n), (this._isScalar = !0), n && (this._isScalar = !1);
        }
        return (
          ...
          (t.prototype._subscribe = function (e) {
            var n = this.value,
              i = this.scheduler;
            if (i) return i.schedule(t.dispatch, 0, { done: !1, value: n, subscriber: e });
  ...
  var vt = f(we => {
    ...
    var np =
      ...
      cp = (function (r) {
        np(t, r);
        function t(e, n) {
          r.call(this), (this.array = e), (this.scheduler = n), !n && e.length === 1 && ((this._isScalar = !0), (this.value = e[0]));
        }
        return (
          (t.create = function (e, n) {
            return new t(e, n);
          ...
          (t.of = function () {
            ...
            var o = e.length;
            return o > 1 ? new t(e, i) : o === 1 ? new op.ScalarObservable(e[0], i) : new sp.EmptyObservable(i);
          }),
          (t.dispatch = function (e) {
            var n = e.array,
              i = e.index,
          ...
          (t.prototype._subscribe = function (e) {
            var n = 0,
              ...
              o = i.length,
              s = this.scheduler;
            if (s) return s.schedule(t.dispatch, 0, { array: i, index: n, count: o, subscriber: e });
  ...
  var qt = f(Pt => {
    ...
    function Wi(r) {
      var t = r.Symbol;
      if (typeof t == 'function') return t.iterator || (t.iterator = t('iterator polyfill')), t.iterator;
      var e = r.Set;
      ...
      if (n)
        for (var i = Object.getOwnPropertyNames(n.prototype), o = 0; o < i.length; ++o) {
          var s = i[o];
          if (s !== 'entries' && s !== 'size' && n.prototype[s] === n.prototype.entries) return s;
        }
      return '@@iterator';
    }
  ...
  var Yi = f(Oe => {
    ...
    var mp =
      ...
      vp = (function (r) {
        mp(t, r);
        function t(e, n, i) {
          r.call(this), (this.parent = e), (this.outerValue = n), (this.outerIndex = i), (this.index = 0);
        }
        return (
          (t.prototype._next = function (e) {
  ...
  var Bt = f(Xi => {
    ...
    function Sp(r, t, e, n) {
      ...
      if (t instanceof wp.Observable)
        return t._isScalar ? (i.next(t.value), i.complete(), null) : ((i.syncErrorThrowable = !0), t.subscribe(i));
      if (bp.isArrayLike(t)) {
        ...
        if (t && typeof t[Ki.iterator] == 'function') {
          ...
          if (typeof l.subscribe != 'function') i.error(new TypeError('Provided object does not correctly implement Symbol.observable'));
          else return l.subscribe(new zi.InnerSubscriber(r, e, n));
        } else {
          var h = _p.isObject(t) ? 'an invalid object' : "'" + t + "'",
            _ = 'You provided ' + h + ' where a stream was expected. You can provide an Observable, Promise, Array, or Iterable.';
  ...
  var eo = f(ct => {
    ...
    function Zi() {
      for (var r = [], t = 0; t < arguments.length; t++) r[t - 0] = arguments[t];
      var e = r[r.length - 1];
      return typeof e == 'function' && r.pop(), new Op.ArrayObservable(r).lift(new Qi(e));
    }
    ct.zipStatic = Zi;
    var Qi = (function () {
      function r(t) {
    ...
    var to = (function (r) {
      ...
      return (
        ...
        (t.prototype.checkIterators = function () {
          for (var e = this.iterators, n = e.length, i = this.destination, o = 0; o < n; o++) {
            var s = e[o];
      ...
      Np = (function (r) {
        ...
        return (
          ...
          (t.prototype.next = function () {
            var e = this.buffer;
            return e.length === 0 && this.isComplete ? { value: null, done: !0 } : { value: e.shift(), done: !1 };
          }),
  ...
  var Dr = f((bb, io) => {
    ...
    io.exports = function (t) {
      ...
      for (var o = Pp.exec(t || ''), s = {}, a = 14; a--; ) s[qp[a]] = o[a] || '';
      return (
        n != -1 &&
          i != -1 &&
          ((s.source = e),
  ...
  var ao = f((_b, $r) => {
    try {
      $r.exports = typeof XMLHttpRequest < 'u' && 'withCredentials' in new XMLHttpRequest();
    } catch {
      $r.exports = !1;
    }
  });
  var ut = f(uo => {
    ...
    D.prototype.emit = function (r) {
      ...
      for (var t = new Array(arguments.length - 1), e = this._callbacks['$' + r], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
      if (e) {
        e = e.slice(0);
  ...
  var Yr = f((Db, xo) => {
    'use strict';
    var So = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_'.split(''),
      Ae = 64,
      Oo = {},
      _o = 0,
      nt = 0,
  ...
  var Ce = f(Kr => {
    Kr.encode = function (r) {
      var t = '';
      for (var e in r) r.hasOwnProperty(e) && (t.length && (t += '&'), (t += encodeURIComponent(e) + '=' + encodeURIComponent(r[e])));
      return t;
    };
  ...
  var zo = f(Pe => {
    ...
    var oh =
      ...
      ah = (function (r) {
        oh(t, r);
        function t(e, n) {
          r.call(this), (this.subject = e), (this.subscriber = n), (this.closed = !1);
        }
        return (
          (t.prototype.unsubscribe = function () {
            if (!this.closed) {
              ...
              var e = this.subject,
                n = e.observers;
              if (((this.subject = null), !(!n || n.length === 0 || e.isStopped || e.closed))) {
  ...
  var Kt = f(_t => {
    ...
    var Jo = (function (r) {
      on(t, r);
      function t() {
        r.call(this), (this.observers = []), (this.closed = !1), (this.isStopped = !1), (this.hasError = !1), (this.thrownError = null);
      }
      return (
        ...
        (t.prototype.next = function (e) {
          ...
          if (!this.isStopped) for (var n = this.observers, i = n.length, o = n.slice(), s = 0; s < i; s++) o[s].next(e);
        }),
        (t.prototype.error = function (e) {
          if (this.closed) throw new Yt.ObjectUnsubscribedError();
          (this.hasError = !0), (this.thrownError = e), (this.isStopped = !0);
          for (var n = this.observers, i = n.length, o = n.slice(), s = 0; s < i; s++) o[s].error(e);
          this.observers.length = 0;
        }),
        (t.prototype.complete = function () {
          if (this.closed) throw new Yt.ObjectUnsubscribedError();
          this.isStopped = !0;
          for (var e = this.observers, n = e.length, i = e.slice(), o = 0; o < n; o++) i[o].complete();
          this.observers.length = 0;
        }),
        (t.prototype.unsubscribe = function () {
  ...
  var es = f(Gt => {
    ...
    var an =
      ...
      ts = (function (r) {
        an(t, r);
        function t(e, n) {
          r.call(this), (this.source = e), (this.subjectFactory = n), (this._refCount = 0), (this._isComplete = !1);
        }
        return (
          (t.prototype._subscribe = function (e) {
          ...
          (t.prototype.connect = function () {
            ...
            return (
              e ||
                ...
                e.closed ? ((this._connection = null), (e = Qo.Subscription.EMPTY)) : (this._connection = e)),
              e
            );
          }),
  ...
  var I = f(Xt => {
    ...
    function Lh(r, t) {
      return function (n) {
        if (typeof r != 'function') throw new TypeError('argument is not a function. Are you looking for `mapTo()`?');
    ...
    var Mh = (function (r) {
      Bh(t, r);
      function t(e, n, i) {
        r.call(this, e), (this.project = n), (this.count = 0), (this.thisArg = i || this);
      }
      return (
        (t.prototype._next = function (e) {
          var n;
  ...
  var L = f(je => {
    ...
    var $h = (function () {
        ...
        return (
          (r.prototype.call = function (t, e) {
            return e.subscribe(new Uh(t, this.nextOrObserver, this.error, this.complete));
          }),
          r
        );
      })(),
      Uh = (function (r) {
        ...
        return (
          (t.prototype._next = function (e) {
            ...
            n.next(e), n.syncErrorThrown ? this.destination.error(n.syncErrorValue) : this.destination.next(e);
          }),
          (t.prototype._error = function (e) {
            var n = this.safeSubscriber;
            n.error(e), n.syncErrorThrown ? this.destination.error(n.syncErrorValue) : this.destination.error(e);
          }),
          (t.prototype._complete = function () {
  ...
  var hn = f(Me => {
    ...
    var zh =
      ...
      Xh = (function (r) {
        zh(t, r);
        function t(e, n) {
          r.call(this, e, n), (this.scheduler = e), (this.pending = !1), (this.work = n);
        }
        return (
          (t.prototype.schedule = function (e, n) {
          ...
          (t.prototype.requestAsyncId = function (e, n, i) {
            return i === void 0 && (i = 0), ys.root.setInterval(e.flush.bind(e, this), i);
          }),
          (t.prototype.recycleAsyncId = function (e, n, i) {
            return (
              i === void 0 && (i = 0),
              i !== null && this.delay === i && this.pending === !1 ? n : (ys.root.clearInterval(n) && void 0) || void 0
            );
          }),
    ...
    var Jh = (function () {
      ...
      return (
        (r.prototype.schedule = function (t, e, n) {
          return e === void 0 && (e = 0), new this.SchedulerAction(this, t).schedule(n, e);
        }),
        (r.now = Date.now
          ? Date.now
          : function () {
  ...
  var mn = f(Fe => {
    ...
    var Zh =
      ...
      tm = (function (r) {
        Zh(t, r);
        function t() {
          r.apply(this, arguments), (this.actions = []), (this.active = !1), (this.scheduled = void 0);
        }
        return (
      ...
      um = (function (r) {
        ...
        function t(e, n, i) {
          e === void 0 && (e = 0),
            ...
            (this.period = -1),
            (this.dueTime = 0),
            om.isNumeric(n) ? (this.period = (Number(n) < 1 && 1) || Number(n)) : Os.isScheduler(n) && (i = n),
        ...
        return (
          ...
          (t.prototype._subscribe = function (e) {
            var n = 0,
              ...
              s = i.dueTime,
              a = i.scheduler;
            return a.schedule(t.dispatch, s, { index: n, period: o, subscriber: e });
          }),
          t
        );
      })(sm.Observable);
  ...
  var q = f(Ue => {
    ...
    var vm = (function () {
      ...
      ym = (function (r) {
        hm(t, r);
        function t(e, n, i) {
          r.call(this, e), (this.predicate = n), (this.thisArg = i), (this.count = 0);
        }
        return (
          (t.prototype._next = function (e) {
            var n;
  ...
  var x = f(Ve => {
    ...
    var Sm = (function () {
      ...
      Om = (function (r) {
        bm(t, r);
        function t(e, n, i) {
          r.call(this, e), (this.observables = n), (this.project = i), (this.toRespond = []);
          var o = n.length;
  ...
  var ft = f(He => {
    ...
    var Am = (function () {
      ...
      Cm = (function (r) {
        xm(t, r);
        function t(e, n, i) {
          r.call(this, e), (this.project = n), (this.resultSelector = i), (this.index = 0);
        }
        return (
          (t.prototype._next = function (e) {
            var n,
          ...
          (t.prototype._innerSub = function (e, n, i) {
            ...
            o && o.unsubscribe(), this.add((this.innerSubscription = km.subscribeToResult(this, e, n, i)));
          }),
          (t.prototype._complete = function () {
          ...
          (t.prototype.notifyComplete = function (e) {
            this.remove(e), (this.innerSubscription = null), this.isStopped && r.prototype._complete.call(this);
          }),
          (t.prototype.notifyNext = function (e, n, i, o, s) {
            this.resultSelector ? this._tryNotifyNext(e, n, i, o) : this.destination.next(n);
          }),
            ...
            if (o == null)
              this._isScalar
                ...
                : i
                    .then(
                      function (s) {
                        (n.value = s), (n._isScalar = !0), e.closed || (e.next(s), e.complete());
                      },
                      function (s) {
                        e.closed || e.error(s);
                      }
              ...
              if (!e.closed) return o.schedule(ha, 0, { value: this.value, subscriber: e });
            } else
              i.then(
                function (s) {
                  (n.value = s), (n._isScalar = !0), e.closed || e.add(o.schedule(ha, 0, { value: s, subscriber: e }));
                },
                function (s) {
                  e.closed || e.add(o.schedule(Um, 0, { err: s, subscriber: e }));
                }
              ).then(null, function (s) {
                pa.root.setTimeout(function () {
                  throw s;
  ...
  var va = f(Ze => {
    ...
    var Vm =
      ...
      Ym = (function (r) {
        Vm(t, r);
        function t(e, n) {
          if ((r.call(this), (this.scheduler = n), e == null)) throw new Error('iterator cannot be null.');
          this.iterator = Gm(e);
        }
        return (
          (t.create = function (e, n) {
          ...
          (t.prototype._subscribe = function (e) {
            var n = 0,
              ...
              o = i.iterator,
              s = i.scheduler;
            if (s) return s.schedule(t.dispatch, 0, { index: n, iterator: o, subscriber: e });
            do {
              var a = o.next();
              if (a.done) {
                e.complete();
    ...
    var Km = (function () {
        function r(t, e, n) {
          e === void 0 && (e = 0), n === void 0 && (n = t.length), (this.str = t), (this.idx = e), (this.len = n);
        }
        return (
      ...
      zm = (function () {
        function r(t, e, n) {
          e === void 0 && (e = 0), n === void 0 && (n = Xm(t)), (this.arr = t), (this.idx = e), (this.len = n);
        }
        return (
          (r.prototype[Je.iterator] = function () {
            return this;
    ...
    function Xm(r) {
      var t = +r.length;
      return isNaN(t) ? 0 : t === 0 || !Jm(t) ? t : ((t = Zm(t) * Math.floor(Math.abs(t))), t <= 0 ? 0 : t > da ? da : t);
    }
    function Jm(r) {
  ...
  var ya = f(Qe => {
    ...
    var Qm =
      ...
      nd = (function (r) {
        Qm(t, r);
        function t(e, n) {
          r.call(this), (this.arrayLike = e), (this.scheduler = n), !n && e.length === 1 && ((this._isScalar = !0), (this.value = e[0]));
        }
        return (
          (t.create = function (e, n) {
            var i = e.length;
            return i === 0 ? new rd.EmptyObservable() : i === 1 ? new ed.ScalarObservable(e[0], n) : new t(e, n);
          }),
          (t.dispatch = function (e) {
            var n = e.arrayLike,
              i = e.index,
          ...
          (t.prototype._subscribe = function (e) {
            var n = 0,
              ...
              s = i.scheduler,
              a = o.length;
            if (s) return s.schedule(t.dispatch, 0, { arrayLike: o, index: n, length: a, subscriber: e });
      ...
      id = (function () {
        ...
        return (
          ...
          (r.prototype.accept = function (t, e, n) {
            return t && typeof t.next == 'function' ? this.observe(t) : this.do(t, e, n);
          }),
          ...
          (r.createNext = function (t) {
            return typeof t < 'u' ? new r('N', t) : r.undefinedValueNotification;
          }),
  ...
  var Oa = f(pt => {
    ...
    var wa = (function (r) {
      od(t, r);
      function t(e, n, i) {
        i === void 0 && (i = 0), r.call(this, e), (this.scheduler = n), (this.delay = i);
      }
      return (
        (t.dispatch = function (e) {
        ...
        (t.prototype.scheduleMessage = function (e) {
          this.add(this.scheduler.schedule(t.dispatch, this.delay, new Sa(e, this.destination)));
        }),
        (t.prototype._next = function (e) {
    ...
    var cd =
      ...
      bd = (function (r) {
        ...
        return (
          (t.create = function (e, n) {
            if (e != null) {
              if (typeof e[_n.observable] == 'function') return e instanceof xa.Observable && !n ? e : new t(e, n);
              if (ud.isArray(e)) return new md.ArrayObservable(e, n);
              if (ld.isPromise(e)) return new pd.PromiseObservable(e, n);
              if (typeof e[vd.iterator] == 'function' || typeof e == 'string') return new hd.IteratorObservable(e, n);
          ...
          (t.prototype._subscribe = function (e) {
            var n = this.ish,
              i = this.scheduler;
            return i == null ? n[_n.observable]().subscribe(e) : n[_n.observable]().subscribe(new yd.ObserveOnSubscriber(e, i, 0));
          }),
          t
        );
      })(xa.Observable);
  ...
  var ot = f(xt => {
    ...
    function Od(r, t, e) {
      return (
        ...
        function (i) {
          return typeof t == 'number' && ((e = t), (t = null)), i.lift(new Ta(r, t, e));
        }
      );
    }
    xt.mergeMap = Od;
    var Ta = (function () {
      function r(t, e, n) {
        n === void 0 && (n = Number.POSITIVE_INFINITY), (this.project = t), (this.resultSelector = e), (this.concurrent = n);
      }
      return (
        (r.prototype.call = function (t, e) {
          return e.subscribe(new Aa(t, this.project, this.resultSelector, this.concurrent));
        }),
        r
      );
    })();
    ...
    var Aa = (function (r) {
      ...
      return (
        ...
        (t.prototype.notifyNext = function (e, n, i, o, s) {
          this.resultSelector ? this._notifyResultSelector(e, n, i, o) : this.destination.next(n);
        }),
        ...
        (t.prototype.notifyComplete = function (e) {
          ...
          this.remove(e),
            this.active--,
            n.length > 0 ? this._next(n.shift()) : this.active === 0 && this.hasCompleted && this.destination.complete();
        }),
        t
      );
    })(Sd.OuterSubscriber);
  ...
  var er = f(Na => {
    ...
    var Ed = ot(),
      kd = Ra();
    function Td(r) {
      return r === void 0 && (r = Number.POSITIVE_INFINITY), Ed.mergeMap(kd.identity, null, r);
    }
    Na.mergeAll = Td;
  });
  var Pa = f(Ia => {
  ...
  var rr = f(qa => {
    ...
    function qd() {
      for (var r = [], t = 0; t < arguments.length; t++) r[t - 0] = arguments[t];
      return r.length === 1 || (r.length === 2 && Rd.isScheduler(r[1])) ? Id.from(r[0]) : Pd.concatAll()(Nd.of.apply(void 0, r));
    }
    qa.concat = qd;
  });
  var ja = f(Ba => {
  ...
  var Qt = f(Ga => {
    ...
    function Jd() {
      ...
      return (
        Gd.isScheduler(i)
          ? ((n = r.pop()), r.length > 1 && typeof r[r.length - 1] == 'number' && (e = r.pop()))
          : typeof i == 'number' && (e = r.pop()),
        n === null && r.length === 1 && r[0] instanceof Kd.Observable ? r[0] : Xd.mergeAll(e)(new zd.ArrayObservable(r, n))
      );
    }
    Ga.merge = Jd;
  });
  ...
  var pu = f(jn => {
    ...
    var cv = z(),
      lu = (function () {
        function r(t) {
          if (((this.root = t), t.setImmediate && typeof t.setImmediate == 'function'))
            (this.setImmediate = t.setImmediate.bind(t)), (this.clearImmediate = t.clearImmediate.bind(t));
          else {
            (this.nextHandle = 1),
              (this.tasksByHandle = {}),
        ...
        return (
          ...
          (r.prototype.partiallyApplied = function (t) {
            ...
            var i = function o() {
              var s = o,
                a = s.handler,
                u = s.args;
              typeof a == 'function' ? a.apply(void 0, u) : new Function('' + a)();
            };
          ...
          (r.prototype.createProcessNextTickSetImmediate = function () {
            var t = function e() {
              ...
              return n.root.process.nextTick(n.partiallyApplied(n.runIfPresent, i)), i;
            };
          ...
          (r.prototype.createPostMessageSetImmediate = function () {
            var t = this.root,
              ...
              n = function o(s) {
                var a = o.instance;
                s.source === t && typeof s.data == 'string' && s.data.indexOf(e) === 0 && a.runIfPresent(+s.data.slice(e.length));
              };
            ...
            var t = function e() {
              ...
              return (
                (u.onreadystatechange = function () {
                  n.runIfPresent(a), (u.onreadystatechange = null), s.removeChild(u), (u = null);
                }),
                s.appendChild(u),
                a
              );
          ...
          (r.prototype.createSetTimeoutSetImmediate = function () {
            var t = function e() {
              var n = e.instance,
                i = n.addFromSetImmediateArguments(arguments);
              return n.root.setTimeout(n.partiallyApplied(n.runIfPresent, i), 0), i;
            };
            return (t.instance = this), t;
          }),
          r
          ...
          (t.prototype.requestAsyncId = function (e, n, i) {
            return (
              ...
              i !== null && i > 0
                ...
                : (e.actions.push(this), e.scheduled || (e.scheduled = hu.Immediate.setImmediate(e.flush.bind(e, null))))
            );
          }),
          (t.prototype.recycleAsyncId = function (e, n, i) {
            if ((i === void 0 && (i = 0), (i !== null && i > 0) || (i === null && this.delay > 0)))
              return r.prototype.recycleAsyncId.call(this, e, n, i);
            e.actions.length === 0 && (hu.Immediate.clearImmediate(n), (e.scheduled = void 0));
          }),
          t
        );
      })(fv.AsyncAction);
      ...
      _v = (function (r) {
        ...
        function t(e, n, i) {
          n === void 0 && (n = 0),
            ...
            (!i || typeof i.schedule != 'function') && (this.scheduler = Ln.asap);
        }
        return (
          (t.create = function (e, n, i) {
            return n === void 0 && (n = 0), i === void 0 && (i = Ln.asap), new t(e, n, i);
          }),
          (t.dispatch = function (e) {
            var n = e.source,
              i = e.subscriber;
  ...
  var _u = f(gu => {
    ...
    var Ov = (function () {
      ...
      return (
        (r.prototype.call = function (t, e) {
          return new wv.SubscribeOnObservable(e, this.delay, this.scheduler).subscribe(t);
        }),
        r
      );
    })();
  ...
  var ne = f(yr => {
    ...
    var qv = (function () {
      ...
      Bv = (function (r) {
        Nv(t, r);
        function t(e, n, i) {
          r.call(this, e), (this.keySelector = i), (this.hasKey = !1), typeof n == 'function' && (this.compare = n);
        }
        return (
          ...
          (t.prototype._next = function (e) {
            var n = this.keySelector,
              i = e;
            if (n && ((i = lf.tryCatch(this.keySelector)(e)), i === vr.errorObject)) return this.destination.error(vr.errorObject.e);
            var o = !1;
            if (this.hasKey) {
              if (((o = lf.tryCatch(this.compare)(this.key, i)), o === vr.errorObject)) return this.destination.error(vr.errorObject.e);
            } else this.hasKey = !0;
  ...
  var mf = f(br => {
    ...
    var Yv = (function (r) {
      jv(t, r);
      function t(e, n, i, o) {
        r.call(this), (this.sourceObj = e), (this.eventName = n), (this.selector = i), (this.options = o);
      }
      return (
        ...
        (t.setupSubscription = function (e, n, i, o, s) {
          var a;
          if (Vv(e) || Hv(e)) for (var u = 0, l = e.length; u < l; u++) t.setupSubscription(e[u], n, i, o, s);
          else if (Wv(e)) {
            var h = e;
    ...
    var zv = (function () {
      ...
      return (
        ...
        (r.prototype.delete = function (t) {
          var e = this._keys.indexOf(t);
          return e === -1 ? !1 : (this._values.splice(e, 1), this._keys.splice(e, 1), this.size--, !0);
        }),
  ...
  var tl = f(Qf => {
    ...
    var Jv = (function () {
      ...
      return (
        ...
        (r.prototype.forEach = function (t, e) {
          var n = this.values;
          for (var i in n) n.hasOwnProperty(i) && n[i] !== null && t.call(e, n[i], i);
        }),
        (r.prototype.clear = function () {
          this.values = {};
        }),
  ...
  var nl = f(oe => {
    ...
    var ny = (function () {
        ...
        return (
          (r.prototype.call = function (t, e) {
            return e.subscribe(new iy(t, this.keySelector, this.elementSelector, this.durationSelector, this.subjectSelector));
          }),
          r
        );
      })(),
      iy = (function (r) {
        ...
        return (
          ...
          (t.prototype._group = function (e, n) {
            var i = this.groups;
            i || (i = this.groups = typeof n == 'string' ? new ey.FastMap() : new ty.Map());
            var o = i.get(n),
              s;
            ...
            if (!o) {
              (o = this.subjectSelector ? this.subjectSelector() : new Qv.Subject()), i.set(n, o);
      ...
      zn = (function (r) {
        Or(t, r);
        function t(e, n, i) {
          r.call(this), (this.key = e), (this.groupSubject = n), (this.refCountSubscription = i);
        }
        return (
          (t.prototype._subscribe = function (e) {
    ...
    var sy = (function (r) {
      ...
      return (
        (t.prototype.unsubscribe = function () {
          ...
          !e.closed &&
            !this.closed &&
            (r.prototype.unsubscribe.call(this), (e.count -= 1), e.count === 0 && e.attemptedToUnsubscribe && e.unsubscribe());
        }),
        t
      );
    })(rl.Subscription);
  ...
  function so(r, t = '', e) {
    ...
    (e = e || (typeof location < 'u' && location)),
      ...
      typeof r == 'string' &&
        (r.charAt(0) === '/' && (r.charAt(1) === '/' ? (r = e.protocol + r) : (r = e.host + r)),
        /^(https?|wss?):\/\//.test(r) || (typeof e < 'u' ? (r = e.protocol + '//' + r) : (r = 'https://' + r)),
        (n = (0, oo.default)(r))),
  ...
  var co = c(ao(), 1);
  var Y = (() => (typeof self < 'u' ? self : typeof window < 'u' ? window : Function('return this')()))();
  function Ur(r) {
    let t = r.xdomain;
    try {
      if (typeof XMLHttpRequest < 'u' && (!t || co.default)) return new XMLHttpRequest();
    } catch {}
    if (!t)
      try {
  ...
  function Q(r, t) {
    t.useNativeTimers
      ...
      : ((r.setTimeoutFn = setTimeout.bind(Y)), (r.clearTimeoutFn = clearTimeout.bind(Y)));
  }
  var Ao = c(ut(), 1);
  ...
  var Dp = typeof Blob == 'function' || (typeof Blob < 'u' && Object.prototype.toString.call(Blob) === '[object BlobConstructor]'),
    $p = typeof ArrayBuffer == 'function',
    Up = r => (typeof ArrayBuffer.isView == 'function' ? ArrayBuffer.isView(r) : r && r.buffer instanceof ArrayBuffer),
  ...
  var yt = class extends go.Emitter {
    constructor(t) {
      super();
      (this.writable = !1), Q(this, t), (this.opts = t), (this.query = t.query), (this.readyState = ''), (this.socket = t.socket);
    }
    onError(t, e) {
      let n = new Error(t);
      return (n.type = 'TransportError'), (n.description = e), super.emit('error', n), this;
    }
    open() {
  ...
  var zr = class extends yt {
    ...
    onData(t) {
      let e = n => {
        if ((this.readyState === 'opening' && n.type === 'open' && this.onOpen(), n.type === 'close')) return this.onClose(), !1;
        this.onPacket(n);
      };
      bo(t, this.socket.binaryType).forEach(e),
        this.readyState !== 'closed' && ((this.polling = !1), this.emit('pollComplete'), this.readyState === 'open' && this.poll());
    }
    doClose() {
      let t = () => {
    ...
    uri() {
      let t = this.query || {},
        ...
        n = '';
      this.opts.timestampRequests !== !1 && (t[this.opts.timestampParam] = (0, Eo.default)()),
        !this.supportsBinary && !t.sid && (t.b64 = 1),
        this.opts.port &&
          ((e === 'https' && Number(this.opts.port) !== 443) || (e === 'http' && Number(this.opts.port) !== 80)) &&
          (n = ':' + this.opts.port);
  ...
  var Gp = (function () {
    ...
    Gr = class extends zr {
      ...
      request(t = {}) {
        return Object.assign(t, { xd: this.xd, xs: this.xs }, this.opts), new X(this.uri(), t);
      }
      doWrite(t, e) {
    ...
    X = class extends Ao.Emitter {
      ...
      create() {
        let t = Ee(this.opts, 'agent', 'pfx', 'key', 'passphrase', 'cert', 'ca', 'ciphers', 'rejectUnauthorized', 'autoUnref');
        ...
        typeof document < 'u' && ((this.index = X.requestsCount++), (X.requests[this.index] = this));
      }
      onSuccess() {
      ...
      cleanup(t) {
        if (!(typeof this.xhr > 'u' || this.xhr === null)) {
          ...
          typeof document < 'u' && delete X.requests[this.index], (this.xhr = null);
        }
      }
      onLoad() {
  ...
  function To() {
    for (let r in X.requests) X.requests.hasOwnProperty(r) && X.requests[r].abort();
  }
  var Io = c(Ce(), 1),
    Po = c(Yr(), 1);
  var Co = (() =>
      typeof Promise == 'function' && typeof Promise.resolve == 'function' ? t => Promise.resolve().then(t) : (t, e) => e(t, 0))(),
    bt = Y.WebSocket || Y.MozWebSocket,
    Re = !0,
    Ro = 'arraybuffer';
  var No = typeof navigator < 'u' && typeof navigator.product == 'string' && navigator.product.toLowerCase() === 'reactnative',
    Ft = class extends yt {
      constructor(t) {
        super(t);
      ...
      doOpen() {
        ...
        try {
          this.ws = Re && !No ? (e ? new bt(t, e) : new bt(t)) : new bt(t, e, n);
        } catch (i) {
          return this.emit('error', i);
        }
        (this.ws.binaryType = this.socket.binaryType || Ro), this.addEventListeners();
      }
      addEventListeners() {
        (this.ws.onopen = () => {
          ...
          ke(n, this.supportsBinary, o => {
            ...
            Re ||
              ...
              this.opts.perMessageDeflate &&
                (typeof o == 'string' ? Buffer.byteLength(o) : o.length) < this.opts.perMessageDeflate.threshold &&
                (s.compress = !1));
            try {
      ...
      uri() {
        let t = this.query || {},
          ...
          n = '';
        this.opts.port &&
          ((e === 'wss' && Number(this.opts.port) !== 443) || (e === 'ws' && Number(this.opts.port) !== 80)) &&
          (n = ':' + this.opts.port),
          this.opts.timestampRequests && (t[this.opts.timestampParam] = (0, Po.default)()),
      ...
      check() {
        return !!bt && !('__initialize' in bt && this.name === Ft.prototype.name);
      }
    };
  ...
  var K = class extends Bo.Emitter {
    constructor(t, e = {}) {
      ...
      t && typeof t == 'object' && ((e = t), (t = null)),
        ...
        typeof this.opts.query == 'string' && (this.opts.query = qo.default.decode(this.opts.query)),
        (this.id = null),
        (this.upgrades = null),
    ...
    open() {
      let t;
      if (this.opts.rememberUpgrade && K.priorWebsocketSuccess && this.transports.indexOf('websocket') !== -1) t = 'websocket';
    ...
    probe(t) {
      ...
      e.once('open', i), e.once('error', s), e.once('close', a), this.once('close', u), this.once('upgrading', l), e.open();
    }
    onOpen() {
      if (
    ...
    onError(t) {
      (K.priorWebsocketSuccess = !1), this.emitReserved('error', t), this.onClose('transport error', t);
    }
    onClose(t, e) {
  ...
  var lg = K.protocol;
  var tn = {};
  Sl(tn, { Decoder: () => Ne, Encoder: () => $o, PacketType: () => S, protocol: () => Do });
  var Fo = c(ut(), 1);
  var Jp = typeof ArrayBuffer == 'function',
    Zp = r => (typeof ArrayBuffer.isView == 'function' ? ArrayBuffer.isView(r) : r.buffer instanceof ArrayBuffer),
    jo = Object.prototype.toString,
    Qp = typeof Blob == 'function' || (typeof Blob < 'u' && jo.call(Blob) === '[object BlobConstructor]'),
    th = typeof File == 'function' || (typeof File < 'u' && jo.call(File) === '[object FileConstructor]');
  function $t(r) {
    return (Jp && (r instanceof ArrayBuffer || Zp(r))) || (Qp && r instanceof Blob) || (th && r instanceof File);
  }
  function Dt(r, t) {
    ...
    if ($t(r)) return !0;
    if (r.toJSON && typeof r.toJSON == 'function' && arguments.length === 1) return Dt(r.toJSON(), !0);
    for (let e in r) if (Object.prototype.hasOwnProperty.call(r, e) && Dt(r[e])) return !0;
    return !1;
  }
  function Lo(r) {
    let t = [],
      e = r.data,
      n = r;
    return (n.data = Zr(e, t)), (n.attachments = t.length), { packet: n, buffers: t };
  }
  function Zr(r, t) {
    if (!r) return r;
    if ($t(r)) {
      ...
      let e = {};
      for (let n in r) Object.prototype.hasOwnProperty.call(r, n) && (e[n] = Zr(r[n], t));
      return e;
    }
    return r;
  }
  ...
  function Qr(r, t) {
    ...
    else if (typeof r == 'object') for (let e in r) Object.prototype.hasOwnProperty.call(r, e) && (r[e] = Qr(r[e], t));
    return r;
  }
  var Do = 5,
    S;
  ...
  var $o = class {
      encode(t) {
        return (t.type === S.EVENT || t.type === S.ACK) && Dt(t)
          ? ((t.type = t.type === S.EVENT ? S.BINARY_EVENT : S.BINARY_ACK), this.encodeAsBinary(t))
          : [this.encodeAsString(t)];
      }
      encodeAsString(t) {
        let e = '' + t.type;
        return (
          (t.type === S.BINARY_EVENT || t.type === S.BINARY_ACK) && (e += t.attachments + '-'),
          t.nsp && t.nsp !== '/' && (e += t.nsp + ','),
          t.id != null && (e += t.id),
    ...
    Ne = class extends Fo.Emitter {
        ...
        if (typeof t == 'string')
          (e = this.decodeString(t)),
            e.type === S.BINARY_EVENT || e.type === S.BINARY_ACK
              ? ((this.reconstructor = new Uo(e)), e.attachments === 0 && super.emitReserved('decoded', e))
      ...
      decodeString(t) {
        ...
        if (S[n.type] === void 0) throw new Error('unknown packet type ' + n.type);
  ...
  var Vo = c(ut(), 1),
    rh = Object.freeze({ connect: 1, connect_error: 1, disconnect: 1, disconnecting: 1, newListener: 1, removeListener: 1 }),
    Ut = class extends Vo.Emitter {
      ...
      connect() {
        return this.connected
          ? this
          : (this.subEvents(), this.io._reconnecting || this.io.open(), this.io._readyState === 'open' && this.onopen(), this);
      }
      open() {
        return this.connect();
      }
      ...
      emit(t, ...e) {
        if (rh.hasOwnProperty(t)) throw new Error('"' + t + '" is a reserved event name');
        e.unshift(t);
        ...
        return (
          (this.flags.volatile && (!i || !this.connected)) || (this.connected ? this.packet(n) : this.sendBuffer.push(n)),
          (this.flags = {}),
          this
        );
      }
    ...
    Vt = class extends Ko.Emitter {
      constructor(t, e) {
        ...
        (this.nsps = {}),
          ...
          this.randomizationFactor((n = e.randomizationFactor) !== null && n !== void 0 ? n : 0.5),
      ...
      reconnectionDelay(t) {
        ...
        return t === void 0
          ...
          : ((this._reconnectionDelay = t), (e = this.backoff) === null || e === void 0 || e.setMin(t), this);
      }
      randomizationFactor(t) {
        var e;
        return t === void 0
          ? this._randomizationFactor
          : ((this._randomizationFactor = t), (e = this.backoff) === null || e === void 0 || e.setJitter(t), this);
      }
      reconnectionDelayMax(t) {
        var e;
        return t === void 0
          ? this._reconnectionDelayMax
          : ((this._reconnectionDelayMax = t), (e = this.backoff) === null || e === void 0 || e.setMax(t), this);
      }
      timeout(t) {
  ...
  function ps(r) {
    var t = qh,
      e;
    if (r.notify.styles)
      if (Object.prototype.toString.call(r.notify.styles) === '[object Array]') t = r.notify.styles.join(';');
      else for (var n in r.notify.styles) r.notify.styles.hasOwnProperty(n) && (t[n] = r.notify.styles[n]);
    if (((e = document.createElement('DIV')), (e.id = '__bs_notify__'), typeof t == 'string')) e.style.cssText = t;
  ...
  var Cs = c(it()),
    Rs = c($e()),
    Ns = c(J());
  var lm = { trace: '\u{1F50D}', debug: '\u{1F41B}', info: '\u2728', warn: '\u26A0\uFE0F', error: '\u{1F6A8}', fatal: '\u{1F480}' },
    ...
    Ts = (function () {
      function r(t, e) {
        (this.name = t), (this.opts = e), (this._name = t || ''), (this._colors = F(F({}, pm), e.colors || {}));
        try {
        ...
        (r.prototype._print = function (t) {
          if (!(ks[t] < this._logLevel)) {
            var e = lm[t],
              ...
              i = t === 'error' || t.fatal ? this._colors.red : t === 'warn' ? this._colors.yellow : this._colors.green,
              o = [],
              s = [null],
              a = e + ' %c%s';
            ...
            for (var u = 1, l = arguments.length; u < l; u++) {
              ...
              typeof h == 'string'
                ? u === 1
                  ...
                  : /ms$/.test(h)
                  ? ((a += ' %c%s'), s.push(Jt(this._colors.brightBlack)), s.push(h))
  ...
  var js = new Cs.BehaviorSubject(
    ...
    (We[tt.Log] = function (r, t) {
      return r.pipe(
        (0, yn.withLatestFrom)(t.logInstance$, t.option$.pipe((0, Ps.pluck)('injectNotification'))),
      ...
      return r.pipe(
        ...
        (0, Ye.tap)(function (e) {
          var n = e[0],
            ...
            o = e[2],
            s = e[3];
          (o.innerHTML = n[0]), (o.style.display = 'block'), s.body.appendChild(o);
        }),
  ...
  function Fs(r) {
    return r.pipe(
      ...
      (0, Ls.map)(function (t) {
        return wt('[PropSet]', t.target, ''.concat(t.prop, ' = ').concat(t.pathname));
      })
    );
  }
  function Ds(r) {
  ...
  function Gs(r, t) {
    return r.pipe(
      (0, Ks.withLatestFrom)(t.option$.pipe((0, zs.pluck)('injectNotification'))),
  ...
  var xn = function (r) {
      var t, e, n;
      return (
        (e = r.indexOf('#')) >= 0 ? ((t = r.slice(e)), (r = r.slice(0, e))) : (t = ''),
        (e = r.indexOf('?')) >= 0 ? ((n = r.slice(e)), (r = r.slice(0, e))) : (n = ''),
    ...
    Wa = function (r, t) {
      ...
      for (var e = r.split('/').reverse(), n = t.split('/').reverse(), i = Math.min(e.length, n.length), o = 0; o < i && e[o] === n[o]; )
        ++o;
      return o;
    },
    En = function (r, t) {
    ...
    return (
      ...
      r.pipe(
        (0, $a.switchMap)(function () {
          return (0, Ma.concat)((0, Da.of)(!1), (0, Fa.timer)(t).pipe((0, Va.mapTo)(!0)));
        }),
        (0, Ua.startWith)(!0)
      )
    );
  ...
  function ec(r, t) {
    return function (p, y) {
      ...
      for (var d = n(p.ext, y, r), v = e(d.elems, p.basename, d.attr), g = 0, w = v.length; g < w; g += 1) a(v[g], d, y, r, t);
      return (0, or.empty)();
    };
    function e(p, y, b) {
      if (y[0] === '*') return p;
      for (var d = [], v = new RegExp('(^|/)' + y), g = 0, w = p.length; g < w; g += 1) v.test(p[g][b]) && d.push(p[g]);
      return d;
    }
    function n(p, y, b) {
      var d = y.tagNames[p],
    ...
    function i(p, y) {
      ...
      return (0, Za.merge)(
        (0, Et.from)([].slice.call(y.images)).pipe(
          ...
          (0, cr.map)(function (d) {
            var v = { target: d, prop: 'src', value: h(d.src, b), pathname: Zt(d.src).pathname };
            return Ds(v);
          })
        ),
        (0, Et.from)(Xa).pipe(
          (0, ee.mergeMap)(function (d) {
            var v = d.selector,
              g = d.styleNames;
            return (0, Et.from)(y.querySelectorAll('[style*='.concat(v, ']'))).pipe(
    ...
    function s(p, y, b, d) {
      return (0, Et.from)(y).pipe(
        ...
        (0, cr.map)(function (v) {
          var g,
            w = p[v],
            E = w.replace(new RegExp('\\burl\\s*\\(([^)]*)\\)'), function (T, A) {
              var H = A;
              return (
                A[0] === '"' && A[A.length - 1] === '"' && (H = A.slice(1, -1)),
                (g = Zt(H).pathname),
        ...
        (0, cr.map)(function (v) {
          var g = v[0],
            ...
            T = v[3],
            A = v[4];
          return Hs({ style: g, styleName: w, value: E, newValue: T, pathName: A });
        })
      );
    }
    function a(p, y, b, d, v) {
      ...
      switch (y.tagName) {
        ...
        default:
          b.timestamps === !1 ? (p[g] = H.href) : (p[g] = H.href.split('?')[0] + $),
            setTimeout(function () {
              te ? ((te.style.display = 'none'), (te.style.display = 'block')) : ((te = d.createElement('DIV')), d.body.appendChild(te));
            }, 200);
      }
    ...
    function u(p, y, b) {
      ...
      (p.__LiveReload_pendingRemoval = !0),
        p.tagName === 'STYLE'
          ? ((d = y.createElement('link')), (d.rel = 'stylesheet'), (d.media = p.media), (d.disabled = p.disabled))
          : (d = p.cloneNode(!1));
      var v = p.href,
        g = h(C(p));
      d.href = g;
        ...
        Ja.Observable.create(function (H) {
          ...
          (0, ee.mergeMap)(function () {
            return (0, sr.timer)(A).pipe(
              (0, ur.tap)(function () {
                (p && !p.parentNode) || (p.parentNode.removeChild(p), (d.onreadystatechange = null));
              }),
              (0, Qa.mapTo)(Xs({ target: d, nextHref: g, prevHref: v, pathname: w, basename: E }))
            );
          })
        )
      );
        ...
        (0, sr.timer)(200).pipe(
          (0, ur.tap)(function () {
            A.parentNode && A.parentNode.removeChild(A),
              b.__LiveReload_newHref === w && (g.insertRule(T, d), g.deleteRule(d + 1), (b = g.cssRules[d]), (b.__LiveReload_newHref = w));
          }),
          (0, ee.mergeMap)(function () {
            return (0, sr.timer)(200).pipe(
              (0, ur.tap)(function () {
                if (b.__LiveReload_newHref === w) return g.insertRule(T, d), g.deleteRule(d + 1);
              })
            );
          })
        )
    ...
    function h(p, y) {
      ...
      return g === v && (v.length === 0 ? (g = '?'.concat(y)) : (g = ''.concat(v, '&').concat(y))), p + g + d;
    }
    function _(p, y, b) {
      ...
      if (E) return E.object && E.object.rule ? l(E.object, y) : u(E.object, y, b);
      if (d.length) {
        var T = p.split('.'),
          A = T[0],
          H = T.slice(1);
          ...
          for (var E = 0; E < w.length; E++) {
            ...
            switch (T.type) {
              case CSSRule.CHARSET_RULE:
                break;
              case CSSRule.IMPORT_RULE:
                b.push({ link: g, rule: T, index: E, href: T.href }), v(g, d(T.styleSheet));
                break;
              default:
                break;
            }
  ...
  function uc(r, t) {
    return r.pipe(
      ...
      (0, ac.tap)(function (e) {
        var n = e[0],
          i = e[1];
        if (n.path) return (i.location = i.location.protocol + '//' + i.location.host + n.path);
  ...
  function Tn(r, t) {
    ...
    return (
      r.pageYOffset !== void 0
        ...
        : ((e = i.scrollLeft || o.scrollLeft || 0), (n = i.scrollTop || o.scrollTop || 0)),
      { x: e, y: n }
    );
  }
  function An(r) {
    var t = r.documentElement,
      e = r.body;
    return { x: e.scrollHeight - t.clientWidth, y: e.scrollHeight - t.clientHeight };
  }
  function nv(r, t) {
  ...
  function jc(r, t) {
    {
      var e = r.pipe((0, Nn.withLatestFrom)(t.window$, t.document$, t.option$.pipe((0, Cn.pluck)('scrollProportionally')))),
      ...
      return (0, qc.merge)(
        i.pipe(
          (0, fr.tap)(function (l) {
            var h = l[0],
              ...
              C = l[3],
              R = An(m);
            return C ? _.scrollTo(0, R.y * h.position.proportional) : _.scrollTo(0, h.position.raw.y);
          })
        ),
        u.pipe(
          (0, fr.tap)(function (l) {
        ...
        a.pipe(
          (0, Nn.withLatestFrom)(t.option$.pipe((0, Cn.pluck)('scrollElementMapping'))),
          (0, Bc.map)(function (l) {
            var h = l[0],
              _ = l[1],
              m = h[0];
  ...
  function Ic(r, t, e) {
    return t && r.scrollTo ? r.scrollTo(0, r.scrollHeight * e.position.proportional) : r.scrollTo(0, e.position.raw.y);
  }
  var Lc = c(L()),
    Mc = c(x());
  function Fc() {
  ...
  function Pn(r, t, e, n) {
    return n === void 0 && (n = -1), [U.Scroll, { position: r, tagName: t, index: e, mappingIndex: n }];
  }
  function Kc(r, t) {
    return r.pipe(
      (0, Yc.withLatestFrom)(t.option$.pipe((0, In.pluck)('ghostMode', 'scroll')), t.window$.pipe((0, In.pluck)('location', 'pathname'))),
  ...
  function Zc(r, t) {
    return r.pipe(
      (0, Xc.withLatestFrom)(t.option$.pipe((0, qn.pluck)('ghostMode', 'clicks')), t.window$.pipe((0, qn.pluck)('location', 'pathname'))),
  ...
  function fu(r, t) {
    return r.pipe(
      (0, uu.withLatestFrom)(t.option$.pipe((0, su.pluck)('ghostMode', 'location'))),
  ...
  function Fn() {
    return (0, xu.concat)((0, Mn.of)(Dc()), (0, Mn.of)(Fc()).pipe((0, Eu.subscribeOn)(ku.async)));
  }
  var Au = c(q()),
    Cu = c(at());
  var Ru = c(J()),
  ...
  function Pu(r, t) {
    return r.pipe(
      ...
      (0, Iu.mergeMap)(function (e) {
        var n = e[0],
          i = e[1];
        return n.url || !i.injectChanges ? Fn() : n.basename && n.ext && Ka(n) ? (0, Cu.empty)() : (0, Ru.of)(ic(n));
      })
    );
  }
  var qu = c(M()),
  ...
  var U;
  (function (r) {
    (r.Scroll = '@@outgoing/scroll'), (r.Click = '@@outgoing/click'), (r.Keyup = '@@outgoing/keyup'), (r.InputToggle = '@@outgoing/Toggle');
  })(U || (U = {}));
  ...
  function mr(r) {
    return function (t, e) {
      return t.pipe(
        (0, Xu.withLatestFrom)(e.io$, e.window$.pipe((0, Qu.pluck)('location', 'pathname'))),
        (0, Zu.tap)(function (n) {
          var i = n[0],
            o = n[1],
            s = n[2];
  ...
  function uf(r) {
    ...
    if (((r.name = r.name.replace(cf, '')), t && t.bs && t.bs.hardReload && t.bs.scroll)) {
      var e = t.bs.scroll,
        n = e.x,
        i = e.y;
      return (0, nf.of)(ta(n, i), Bs('[ScrollRestore] x = '.concat(n, ' y = ').concat(i)));
    }
    return (0, rf.empty)();
  }
    ...
    ($n[O.PreBrowserReload] = function (r, t) {
      return r.pipe(
        ...
        (0, Un.map)(function (e) {
          var n = e[1],
            i = e[2];
          return [n.name, sf, JSON.stringify({ bs: { hardReload: !0, scroll: Tn(n, i) } }), af].join('');
        }),
        (0, Un.map)(function (e) {
          return sa(e);
        })
          ...
          ? (0, Wf.fromEvent)(r, 'change', !0).pipe(
              ...
              (0, Kn.map)(function (o) {
                var s = o[0],
                  a = o[1],
                  u = kt(s);
                return Wu(u, { type: s.type, checked: s.checked, value: s.value });
              })
            )
          : (0, Hf.empty)();
      })
  ...
  function zf(r, t, e, n) {
    var i = (0, Kf.merge)(Mf(r, t, e, n), Nf(t, e, n), Of(t, e, n), Yf(t, e, n));
    return i;
  }
  var ol = c(nl()),
    sl = c(x()),
